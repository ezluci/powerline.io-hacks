...
export class Camera {
   constructor(cV, cq, cY, cd, KT2) {
      ...
      if (KT.firstClick || (this.y = 0x0), KT.isInGame || KT.spectateMode != KT.SPECTATE_FREE || KT.UIVisible) {
         ...
         KT.gameZoom += (KT.targetZoom - KT.gameZoom) / 0xa, this.zoom = KT.gameZoom * (0xa / KT.GAME_SCALE) * (0x1 / (1/*window.devicePixelRatio*/ / KT.defaultRetinaValue)), this.zoom *= KT.zoomAdjust;
         var cq = this.x,
         cY = this.y;
